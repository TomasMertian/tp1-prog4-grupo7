...
export class Materia {
    ...
    getAlumnosInscriptos(): Alumno[] {
        const copiaAlumnos = [...this.alumnosInscriptos];
        return copiaAlumnos;
    }

    getDocentesAsignados(): Docente[] {
        const copiaDocentes = [...this.docentesAsignados];
...
export class Alumno extends Persona {
    ...
    getMaterias(): Materia[] {
        const copiaMaterias = [...this.materias];
        return copiaMaterias;
    }

    obtenerInformacion(): string {
        return `Alumno: ${this.nombre} ${this.apellido}, Legajo: ${this.legajo}, Materias: ${this.materias.length}`;
    }
}
...
export class Docente extends Persona {
    ...
    getMateriasAsignadas(): Materia[] {
        const copiaMateriasAsignadas = [...this.materiasAsignadas];
        return copiaMateriasAsignadas;
    }
